<template>
	<div class="addEdit-block" :style='{"padding":"0 30px","margin":"0 auto","color":"#666","borderRadius":"4px","background":"none","width":"96%","fontSize":"16px"}'>
		...
		>
			<template >
				<el-form-item :style='{"width":"50%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="身高(m)" prop="shengao">
					<el-input-number v-model="ruleForm.shengao" placeholder="身高(m)" :readonly="ro.shengao"></el-input-number>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="身高(m)" prop="shengao">
					<el-input v-model="ruleForm.shengao" placeholder="身高(m)" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="体重(kg)" prop="tizhong">
					<el-input-number v-model="ruleForm.tizhong" placeholder="体重(kg)" :readonly="ro.tizhong"></el-input-number>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="体重(kg)" prop="tizhong">
					<el-input v-model="ruleForm.tizhong" placeholder="体重(kg)" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'" label="bmi" prop="bmi">
					<el-input v-model="bmi" placeholder="bmi" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-else-if="ruleForm.bmi" label="bmi" prop="bmi">
					<el-input v-model="ruleForm.bmi" placeholder="bmi" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="性别" prop="xingbie">
