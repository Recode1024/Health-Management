	...
	<view class="content">
		<view :style='{"minHeight":"100vh","padding":"24rpx 0 0","alignItems":"flex-start","flexWrap":"wrap","background":"#F1F1F1","display":"block","width":"100%","position":"relative","height":"auto"}'>
			...
			<view :style='{"padding":"0","alignItems":"flex-start","flexWrap":"wrap","background":"none","display":"flex","width":"100%","height":"auto"}'>
				...
				<!-- 样式2 -->
				<view class="news-box2" :style='{"padding":"24rpx","margin":"40rpx 0 0","borderRadius":"8rpx","background":"#F6BE1E","flex":"1","width":"calc(100% - 220rpx)","height":"auto"}'>
					<block v-for="(product,index) in list" :key="index">
					  <view @tap="onDetailTap(product)" v-if="index==0" class="list-item" :style='{"border":"2rpx solid #000","padding":"20rpx","margin":"0 0 20rpx","borderRadius":"8rpx","background":"#F7F1DF","width":"100%","position":"relative","height":"auto"}'>
						...
						<view :style='{"padding":"20rpx 0","color":"#666","flexWrap":"wrap","background":"none","display":"flex","width":"100%","fontSize":"24rpx"}'>
							...
							<view :style='{"width":"100%","padding":"0 0px","lineHeight":"48rpx","order":"3"}'>
								...
								<text :style='{"color":"inherit","lineHeight":"1.5","fontSize":"inherit"}'>{{product.addtime}}</text>
							</view>
							...
							<view :style='{"padding":"0 0px","margin":"0 20rpx 0 0","display":"inline-block"}'>
								<text class="icon iconfont icon-chakan9" :style='{"margin":"0 4rpx 0 0","lineHeight":"1.5","fontSize":"inherit","color":"inherit"}'></text>
								<text :style='{"color":"inherit","lineHeight":"1.5","fontSize":"inherit"}'>{{product.clicknum}}</text>
							</view>
						</view>
					  </view>
					  <view @tap="onDetailTap(product)" v-if="index>0" class="list-item" :style='{"padding":"20rpx 0","borderColor":"#000","margin":"0 0 20rpx","borderRadius":"8rpx","borderWidth":"2rpx","background":"#F7F1DF","width":"100%","borderStyle":"solid","height":"auto"}'>
						<view :style='{"padding":"0 20rpx","overflow":"hidden","whiteSpace":"nowrap","color":"#000","width":"100%","lineHeight":"48rpx","fontSize":"28rpx","textOverflow":"ellipsis"}' class="title ">{{product.title}}</view>
		...
		<button :style='{"border":"0","boxShadow":"none","color":"#fff","bottom":"120rpx","right":"120rpx","borderRadius":"100%","background":"#0C77D5","width":"80rpx","lineHeight":"80rpx","fontSize":"28rpx","position":"absolute","height":"80rpx","zIndex":"999"}' v-if="userid && isAuth('news','新增')" class="add-btn" @click="onAddTap()">新增</button>
		<button :style='{"border":"0","boxShadow":"none","color":"#fff","bottom":"120rpx","right":"120rpx","borderRadius":"100%","background":"#0C77D5","width":"80rpx","lineHeight":"80rpx","fontSize":"28rpx","position":"absolute","height":"80rpx","zIndex":"999"}' v-if="!userid && isAuthFront('news','新增')" class="add-btn" @click="onAddTap()">新增</button>
	</view>
</mescroll-uni>
</template>
